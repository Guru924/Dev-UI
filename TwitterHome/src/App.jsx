...
import { emoji, gif, media, poll, schedule, location, globe } from "./assets/index"
      ...
      <div className="flex container mx-auto text-white">
        ...
        <div className="first w-full">
          ...
          <div className="sideBar flex justify-end">
            ...
            <ul className="flex flex-col text-xl space-y-4 px-11 font-bold">
        ...
        <div className="second border-[1px] border-x-[#666a6f] border-y-black w-full">
